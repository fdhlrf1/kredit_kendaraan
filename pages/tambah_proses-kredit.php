...
$active_page = 'tambah_proses-kredit';
...
$sql = "SELECT k.*, p.nama AS nama_pelanggan, p.alamat, kd.merk, kd.model, kd.harga, kd.tipe 
        FROM tkredit k 
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form method="POST" action="action/aksi_tambah_proses-kredit.php">
